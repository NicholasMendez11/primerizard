          ...
          <div className=" lg:mt-0 mt-16">
            ...
            >
              ...
              <p className="text-basepy-1 md:text-left md:py-1 text-gray-700 text-lg lg:text-2xl leading-6 mt-4 text-center ">
                ¡Muchísimas gracias por compartir todos tus conocimientos! Te
                confieso que anteriormente he tomado otros talleres y la verdad
                no había quedado conforme por la manera en que lo explicaban y
                porque todo era muy teórico. No lo sentía real, no se me parecía
                a lo que realmente se vive. Me encantó tu estilo, porque eres
                realista, práctica, nada estricta. 100% justo lo que necesitaba.
              </p>
              <div className="absolute bottom-0 -mb-4 ml-10">
                <img
                  src="https://tuk-cdn.s3.amazonaws.com/can-uploader/testimonials-4-svg2.svg"
