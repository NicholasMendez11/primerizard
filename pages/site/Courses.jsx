  ...
  return (
    <div>
      {coursesToShow.map((userCourse) => {
        const { courseName, details, course, _id, purchaseDate } = userCourse;
            ...
            <div className="md:flex items-center justify-between w-full bg-gray-50">
              ...
              <div className="xl:w-4/6 md:w-1/2 w-full xl:pl-48">
                ...
                >
                  ...
                  secret to one-sentence paragraphs is to use them like a spice:
                  A pinch of cumin can make a meal more savory, but I don’t want
                  to eat a plateful of the stuff.”
                </p>
